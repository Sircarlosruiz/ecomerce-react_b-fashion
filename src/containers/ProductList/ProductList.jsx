...
const ProductList = () => {
    ...
    const formatCurrency = (value) => {
        return value.toLocaleString('es-US', { style: 'currency', currency: 'COR' });
    }
      ...
      <div className="datatable-crud-demo">
        ...
        >
          <div className="confirmation-content">
            ...
            {product && (
              <span>
                ¿Estas seguro que quieres borrar el producto: <b>{product.name}</b>?
              </span>
            )}
          </div>
        </Dialog>
